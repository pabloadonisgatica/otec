@php
    $qualityTabs = [
        ...
        ['label' => 'Requisitos Generales', 'route' => 'quality.profile.edit', 'active' => request()->routeIs('quality.profile.*')],
        ['label' => 'Manual de Calidad', 'route' => 'quality.manual-calidad', 'active' => request()->routeIs('quality.manual-calidad*')],
