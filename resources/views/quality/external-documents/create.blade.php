<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crear Documento Externo</h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden p-6">
                ...
                <form method="POST" action="{{ route('quality.external-documents.store') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required
                               placeholder="Ej: DA-D45-V4 Requisitos para la certificación de Sistema de Gestión según Norma NCh2728:2015"
                    ...
                    <div class="flex items-center gap-3 pt-2">
                        ...
                        <a href="{{ route('quality.external-documents.index') }}" class="text-sm text-gray-600 hover:underline">Volver</a>
                    </div>
