<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Registrar Comunicación</h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden p-6">
                ...
                <form method="POST" action="{{ route('quality.internal-communications.store') }}" class="space-y-5">
                    @csrf

                    @include('quality.internal-communications._form', ['communication' => null])
